...
var goofy = function(){
	...
	$('.app-nicescroll-bar').slimscroll({height:'435px',size: '4px',color: '#878787',disableFadeOut : true,borderRadius:0});
...
function toggleNav(){
	if($(document).find('.slide-nav-toggle').length == 1){
		$('.page-wrapper').css({'margin-left':'220px'});
	}else{
		$('.page-wrapper').css({'margin-left':'42px'});
	}
}
/***** Resize function end *****/
